...
const Masthead: React.FC = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center">
      <video autoPlay loop playsInline className="absolute w-full h-full object-cover">
      ...
      <div className="flex-grow-0 pb-20 md:pb-10 transition-all duration-1000 opacity-100">
